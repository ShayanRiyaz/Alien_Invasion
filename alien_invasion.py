...
##################### GAME EVENT CHECK {Keyboard Press, Mouse Press etc} #########
...
################################# BULLET ###########################################
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # check for any bullts that have hit aliens.
...
######################### ALIEN FLEET FUNCTIONS #################################
    ...
    def _update_aliens(self):
        ...
        if pygame.sprite.spritecollideany(self.ship,
            ...
            #print("Ship Hit!!")
            self._ship_hit()
        # Look for aliens in hitting the bottom of the screen.
